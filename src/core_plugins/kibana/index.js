      ...
      links: [
        {
          ...
          id: 'kibana:visualize:database',
          title: 'Databases',
          order: -1002,
          url: `${kbnBaseUrl}#/databases`,
          description: 'design data visualizations',
          icon: 'plugins/kibana/assets/database.svg',
        }, {
          id: 'kibana:visualize:cloud',
          title: 'Cloud Services',
          order: -1002,
          url: `${kbnBaseUrl}#/visualize`,
          description: 'design data visualizations',
          icon: 'plugins/kibana/assets/cloud_computing.svg',
        }, {
          id: 'kibana:visualize:protocols',
          title: 'Protocols',
          order: -1002,
          url: `${kbnBaseUrl}#/visualize`,
          description: 'design data visualizations',
          icon: 'plugins/kibana/assets/server.svg',
        }, {
          id: 'kibana:visualize:file',
          title: 'Files',
          order: -1002,
          url: `${kbnBaseUrl}#/visualize`,
          description: 'design data visualizations',
          icon: 'plugins/kibana/assets/file.svg',
        }, {
          id: 'kibana:dashboard',
          title: 'Dashboard',
          order: -1001,
